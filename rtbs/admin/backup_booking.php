  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Backup Booking</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
              <li class="breadcrumb-item active">Backup Booking</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Backup Booking</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                      $query = mysqli_query($con, "CALL view_BackupReservationInfos()");
                      $cnt = 1;
                  ...
                  <tr>
                    ...
                    <td><?php echo $result['customerEmailId']?></td>
                   <td><?php echo $result['customerPhoneNumber']?></td>
                   <td><?php echo $result['noAdults']?></td>
                    <td><?php echo $result['noChildrens']?></td>
                    <td><?php echo $result['customerBackupDate']?></td>                
                  </tr>
         <?php $cnt++;} ?>
