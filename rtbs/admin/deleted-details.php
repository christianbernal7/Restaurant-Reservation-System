        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Deleted Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
// Using prepared statement to call the stored procedure with the specific booking ID
$stmt = $con->prepare("CALL deleted_booking(?)");
