            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php
                      $query = mysqli_query($con, "CALL audit_CustomerReservationInfos()");
                      $cnt = 1;
                  ...
                  <tr>
                    ...
                    <td><?php echo $result['actionCi']?></td>
                   ...
                   <td><?php echo $result['noAdults']?></td>
                    ...
                    <td><?php echo $result['actionRi']?></td>
