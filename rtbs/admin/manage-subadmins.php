...
if (strlen($_SESSION['aid']) == 0) { 
    ...
    if ($_GET['action'] == 'delete') {
        ...
        // Call the stored procedure to delete the subadmin
        $stmt = $con->prepare("CALL DeleteSubadmin(?)");
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      $stmt = $con->prepare("CALL GetAllSubAdmins()");
                      $stmt->execute();
                      ...
                      while ($row = $result->fetch_assoc()) {
                          ...
                          <tr>
                              ...
                              <th>
                                  <a href="edit-subadmin.php?said=<?php echo $row['ID']; ?>" title="Edit Sub Admin Details"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                  ...
                                  <a href="reset-subadmin-pwd.php?said=<?php echo $row['ID']; ?>" title="Reset Sub Admin Password"><i class="fa fa-key" aria-hidden="true"></i></a>
                              </th>
                          </tr>
                          <?php
                          $cnt++;
